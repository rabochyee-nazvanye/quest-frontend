...
/**
 * Put with bearer token as auth mechanism.
 * @param {string} path - a path to the resource.
 * @param {object} body - an object with payload.
 * @param {string} token - a bearer JWT token (Optional).
 * @returns {promise} - a fetch promise instance.
 */
export function putWithToken(path, body, token = getToken()) {
  return fetch(path, {
    method: 'PUT',
    headers: {
      Accept: 'application/json',
...
/**
 * Delete with bearer token as auth mechanism.
 * @param {string} path - a path to the resource.
 * @param {object} body - an object with payload.
 * @param {string} token - a bearer JWT token (Optional).
 * @returns {promise} - a fetch promise instance.
 */
export function deleteWithToken(path, token = getToken()) {
  return fetch(path, {
    method: 'DELETE',
    headers: {
      Accept: 'application/json',
