      ...
      if (this.props.team !== undefined) {
        ...
        return (
          <React.Fragment>
            {showMessage()}
            <Divider />
            <p>У тебя ещё нет команды для этого квеста</p>
            <p> &#160; </p>
          </React.Fragment>
        )
      }
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getInviteCode: (teamId) => {
    dispatch(Api.TeamList.getInviteCode(teamId))
  },
  leaveTeam: (teamId) => {
    dispatch(Api.TeamList.leaveTeam(teamId))
  },
  showTeamLeaveMessage: () => {
    dispatch(Api.TeamList.showTeamLeaveMessage())
  },
})
