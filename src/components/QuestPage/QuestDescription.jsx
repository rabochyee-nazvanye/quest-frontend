...
const cups = {
    gold: <div><TrophyOutlined /> style={{"color": "#FA8C16"}}</div>, silver: <div><TrophyOutlined /> style={{"color": "#595959"}}</div>, bronze: <div><TrophyOutlined /> style={{"color": "#5C0011"}}</div>
};
...
class GuestDescription extends Component {
    ...
    mapResults () {
        const a = Object.values(this.state.results);
    ...
    getCup(place) {
        switch(place) {
            case 1:
                return <div><TrophyOutlined /> style={{"color": "#faad14"}}</div>
            case 2:
                return <div><TrophyOutlined />  style={{"color": "#faad14"}}</div>
            case 3:
                return <div><TrophyOutlined />  style={{"color": "#faad14"}}</div>
