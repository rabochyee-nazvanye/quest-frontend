...
import { Button, Col, Row, Steps, Typography, Divider, Spin, Table, Tag } from 'antd'
...
class GuestDescription extends Component {
  ...
  getPin (props) {
    if (props === 0) { return <div style={{ color: '#FA8C16' }}> <TrophyOutlined/></div> }
    if (props === 1) { return <div style={{ color: '#595959' }}> <TrophyOutlined/></div> }
    if (props === 2) { return <div style={{ color: '#5C0011' }}> <TrophyOutlined/></div> } else return ''
  }
  ...
  getRepresentationByState () {
    if (!this.state.dataReady) {
      ...
      if (this.props.quest.status !== 'resultsavailable') {
        return (
          <React.Fragment>
            <p>
              <p>&nbsp;</p>
              ...
              <div className={'about'}>
                ...
                <h3>
                  <div className={'quest-descript'}>
                    <ReactMarkdown source={this.props.quest.description}/>
                  </div>
                </h3>
              </div>
            </p>
        ...
        const commonCol = this.mapResults()
